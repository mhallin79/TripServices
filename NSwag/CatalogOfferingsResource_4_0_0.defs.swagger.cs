...
namespace TripServices
{
    ...
    public partial class CatalogOfferingsResourceClient : ICatalogOfferingsResourceClient
    {
        ...
        public async System.Threading.Tasks.Task<CatalogOfferingsResponse> CreateAirChangeAsync(string view, string sccType, string sccChannelID, bool? upsellInd, bool? asynchInd, CatalogOfferingsQueryRequest catalogOfferingsQueryRequest, string e2ETrackingId, string xAUTH_TRAVELPORT_ACCESSGROUP, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (sccType != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("sccType") + "=").Append(System.Uri.EscapeDataString(ConvertToString(sccType, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (sccChannelID != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("sccChannelID") + "=").Append(System.Uri.EscapeDataString(ConvertToString(sccChannelID, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (upsellInd != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("upsellInd") + "=").Append(System.Uri.EscapeDataString(ConvertToString(upsellInd, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (asynchInd != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("asynchInd") + "=").Append(System.Uri.EscapeDataString(ConvertToString(asynchInd, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "201")
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CatalogOfferingsResponse>(response_, headers_).ConfigureAwait(false);
